...
:::info ページの説明
**ましゅまろ PB は正常に動作しているが、不満・疑問点**がある場合に参照するページです。  
...
アバターによっては、プリセットでアバター由来の二の腕等のコライダーが設定されている場合があります。  
自分で設定したい場合は、二の腕に PB コライダーを追加し、ましゅまろ PB の Physbone 設定の Collider にコライダーを登録してください。

### 胸が伸びすぎる

#### 屈んだ際に胸が伸び過ぎる場合：

設定項目の「垂れ下がりやすさ」の値を小さくすることで、胸が伸びすぎなくなります。
